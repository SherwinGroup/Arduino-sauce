...
int SHOpin = 5;     // <-- Arduino pin delivering the SI (serial-input) pulse to pin 2 of the TSL1402R 
int ROpin = 6
int AOpin = 1;    // <-- Arduino pin connected to pin 4 (analog output 1)of the TSL1402R
int IntArray[1024]; // <-- the array where the readout of the photodiodes is stored, as integers
int holder;
